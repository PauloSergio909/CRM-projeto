...
export class ErrorBoundary extends Component<Props, State> {
  ...
  render() {
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-cb-bg p-6">
          <div className="bg-white rounded-2xl border border-red-100 shadow-sm p-8 max-w-md w-full text-center">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-cb-primary text-white rounded-xl text-sm font-medium hover:opacity-90 transition mx-auto"
            >
